            ...
            <h2 style={{textAlign:'center',marginBottom:'50px', color:'#2B2B52'}}>{`Showing Result for Age: ${props.ageGroup} +`}</h2>
            {
                ...
                mydata.map(d=>{
                    return(
                        ...
                        <h3 style={{color:'#2C3335', }}>{`Pincode: ${d.pincode}`}</h3>
                        {
                            d.sessions.map(a=>{
                                   { 
                                      return(
                                        ...
                                        ?
                                            ...
                                            <Grid item lg={4} md={4} sm={12} xs={12}><h4 style={{textAlign:'center'}}><span className="title">Vaccine:</span><span style={{fontStyle:'bold'}}>{` ${a["vaccine"]}`}</span> || <span className="title">Price:</span><span style={{fontStyle:'bold'}}>{`${d.fee_type}`}</span></h4></Grid>
